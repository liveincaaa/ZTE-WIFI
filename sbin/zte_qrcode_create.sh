...
case $1 in 
 "wifi_create") 
	...
	#tw modify for MIFI webui
	qrencode -o $wifi_ssid_qrcode_name -m 1 -s 2 "$qrcode_text"
...
#	cp $wifi_ssid_qrcode_name $target_web_dir
 ...
 "multi_wifi_create") 
	...
	#tw modify for MIFI webui
	qrencode -o $multi_wifi_ssid_qrcode_name -m 1 -s 2 "$qrcode_text"
...
#	cp $multi_wifi_ssid_qrcode_name $target_web_dir
 ...
 "local_domain_create") 
	...
	#tw modify for MIFI webui
	qrencode -o $local_domain_qrcode_name -m 1 -s 2 "$qrcode_text"
